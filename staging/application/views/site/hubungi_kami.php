            ...
            <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="nama-hubungi-kami">Nama<sup>*</sup></label>
                    <div class="col-sm-10">
                    <input type="text" name="nama-hubungi-kami" id="nama-hubungi-kami" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="tipe-pertanyaan">Tipe Pertanyaan<sup>*</sup></label>
                    <div class="col-sm-10">
                  <select name="tipe-pertanyaan" id="tipe-pertanyaan" class="form-control">
                    <option value="">Pilih Tipe Pertanyaan</option>
                    <option>Pertanyaan Sales </option>
                    <option>Pertanyaan Teknikal </option>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label class="control-label col-sm-2" for="email-hubungi-kami">Email<sup>*</sup></label>
                    <div class="col-sm-10">
                    <input type="email" name="email-hubungi-kami" id="email-hubungi-kami" class="form-control">
                    </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="posisi-pekerjaan">Posisi Pekerjaan<sup>*</sup></label>
                    <div class="col-sm-10">
                    <input type="text" name="posisi-pekerjaan" id="posisi-pekerjaan" class="form-control">
                    </div>
                </div>
                <div class="form-group">
