      ...
      <div class="col-md-2">
        ...
        <div id="navbar" class="navbar-collapse collapse">
           <ul class="nav navbar-nav navbar-right">
                      ...
                      <li><a href="<?php echo base_url('site/applicator'); ?>#varian">Varian Produk</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="main-content">
             <!-- <div class="form-group">
                ...
                <br>
                <form  action="<?php  echo base_url(); ?>site/send-mail-hubungi-kami/applicator" method="POST"  class="form-horizontal">
                <div class="form-group">
