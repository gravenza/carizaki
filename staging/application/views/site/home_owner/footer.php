<!--FOOTER-->
    <section class="footer">
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 footer-one">
          ...
          <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 footer-two">
            <ul>
              <li><a href="<?php  echo base_url(); ?>site/syarat-dan-ketentuan/home_owner">Syarat dan Ketentuan</a></li>
              <li><a href="<?php  echo base_url(); ?>site/kebijakan-privasi/home_owner">Kebijakan Privasi</a></li>
              <!--<li><a href="">Peta Situs</a></li>-->
              <!--<li><a href="">Blog</a></li>-->
              <li><a href="<?php  echo base_url(); ?>site/hubungi-kami/home_owner">Hubungi Kami</a></li>
            </ul>
          </div>
          <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 newsletter footer-three">
    ...
    <div class="modal-content">
     ...
     <div id="myModal" class="modal fade" role="dialog">
      ...
      <div id="myModal_lokasi" class="modal fade" role="dialog">
        ...
        <div id="myModal_applicator" class="modal fade" role="dialog">
        <div class="container">
          <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                   ...
                   <div class="col-md-12 registrasi-align">
                    ...
                    <form name="register-form" id="register-form" method="POST">
                        ...
                        <table>
                          ...
                          <tr><td></td></tr>
                          <tr> <td class="register-bottom"> <span onClick="javascript=sign_up_homeowner();" >Daftar</span></td> </tr>
                        ...
                        <table>
                          ...
                          <tr><td></td></tr>
                          <tr> <td class="register-bottom"> <span onClick="javascript=sign_in_homeowner();">Login</span></td> </tr>
                        ...
                        <table>
                          ...
                          <tr><td></td></tr>
                          <tr> <td class="register-bottom"> <span  onClick="javascript=lupa_password_homeowner();">Proses</span></td> </tr>
