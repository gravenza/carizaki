...
<html>
  <head>
    ...
    <!-- Font Awesome Icons -->
    <link href="<?=base_url('assets/admin/bootstrap/css/font-awesome.min.css');?>" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?=base_url();?>"><b>BLUESCOPE</b></a>
      </div><!-- /.login-logo -->
      ...
      <div class="login-box-body">
        ...
        <?php 
            ...
            echo form_open('Access123/login'); 
        ?>
