    ...
    <div class="box-body">
      <div class="table-responsive">
        ...
        <table class="table no-margin">
          <tr><td>Nama lokasi</td><td><input type="text" name="desc" class="form-control" required></td></tr>
          ...
          <tr><td>Email</td><td><input type="text" name="whatsapp" class="form-control"></td></tr>
