...
<div class="row">
  ...
  <div class="box box-info">
    <div class="box-header with-border">
     ...
     <h3>Masukan Data Tzaki</h3>
    </div>
    <div class="box-body">
      <div class="table-responsive">
        <form action="<?php echo base_url('tzaki/save_data')?>" method="POST" enctype="multipart/form-data">
        <table class="table no-margin">
          ...
          <tr><td>Image</td><td><input type="file" name="image" class="form-control" required></td></tr>
           ...
           <tr><td>Deskripsi</td><td><textarea name="deskripsi"  class="form-control" required></textarea>
