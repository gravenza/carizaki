...
class Cart extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $crud->callback_column('user_id',array($this,'_name_column'));
    ...
    function _name_column($value, $row){
      if($row->type == 'homeowner'){
        $dataUser = $this->db->where('id_homeowner',$row->user_id)->get('tbl_homeowner')->row();
        return $dataUser->nama;
      }else{
        $dataUser = $this->db->where('id_applicator',$row->user_id)->get('tbl_applicator')->row();
        return $dataUser->nama;
      }
    }
