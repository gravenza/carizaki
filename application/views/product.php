...
<content class="product">	
	...
	<section class="product-detail" style="background-image:url(<?php echo base_url('images/product').'/'.$pict; ?>)">
		<div class="container">
