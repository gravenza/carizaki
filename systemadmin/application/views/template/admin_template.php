...
$( document ).ready(function() {
	...
	$('#field-id_provinsi').attr('onchange','loadKab(this.value)');
	//$('#field-id_kabupaten').attr('onchange','loadKab(this.value)');
	...
	function loadKab(n){
		...
		$.get(base_url +'/customer/kabupaten/'+ n, function(data) {
		  $("#id_kabupaten_input_box").html(data)  ;
		});
	}
	
	function loadKec(n){
		var base_url = window.location.origin;
		$.get(base_url +'/customer/kecamatan/'+ n, function(data) {
		  $("#id_kecamatan_input_box").html(data)  ;
		});
	}
	
	function loadKel(n){
		var base_url = window.location.origin;
		$.get(base_url +'/customer/kelurahan/'+ n, function(data) {
		  $("#id_kelurahan_input_box").html(data)  ;
		});
	}
    ...
    <div class="wrapper">  
        <header class="main-header">
            <a href="<?php echo site_url(); ?>" class="logo">
               <span class="logo-mini"><b>3motion</b></span>
               <span class="logo-lg">3Motion CMS</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2011-2018 <a href="http://www.3motion.co.id">3motion.co.id</a>.</strong> All rights reserved.
        </footer>
    </div><!-- ./wrapper -->
    <?php 
