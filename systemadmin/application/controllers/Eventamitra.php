 ...
 */
class Eventamitra extends MX_Controller
{
    ...
    public function index()
    {
         ...
         $data = $this->M_eventamitra->view();

         $this->load->view('events-amitra',$data);
  ...
  {
    	$data['query'] = $this->db->query("select * from sketsa_events_amitra where id = '$videoId'");
